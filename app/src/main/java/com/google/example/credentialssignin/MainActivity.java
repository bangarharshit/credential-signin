...
public class MainActivity extends AppCompatActivity implements
    ...
    private void buildClients(String accountName) {
        ...
        mCredentialsClient = Credentials.getClient(this, new CredentialsOptions.Builder().forceEnableSaveDialog().build());
...
//        }
        ...
        Credential credential = new Credential.Builder("abc@gmail.com")
